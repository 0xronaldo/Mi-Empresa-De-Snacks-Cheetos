module tienda_papasfritas::mercado {
    ...
    // --- CONSTANTES DE ERROR ---
    const E_ID_VENDEDOR_EXISTE: u64 = 0;
    const E_ID_VENDEDOR_NO_EXISTE: u64 = 1;
    const E_ID_CLIENTE_EXISTE: u64 = 2;
    const E_ID_CLIENTE_NO_EXISTE: u64 = 3;
    const E_SNACK_NO_DISPONIBLE: u64 = 4;
    const E_CANTIDAD_INVALIDA: u64 = 5;
    ...
    public fun comprar_snack(
        ...
        *stock = *stock - cantidad;
        ...
        string::append(&mut compra_registro, tipo_snack);
        ...
        let mut mensaje = utf8(b"Compra exitosa de ");
        string::append(&mut mensaje, tipo_snack);
        mensaje
    }
    ...
    public fun obtener_estado_cliente(mercado: &MercadoSnacks, id_cliente: u16): String {
        ...
        string::append(&mut estado, cliente.nombre);
        string::append(&mut estado, utf8(b", Nivel: "));
        match (cliente.nivel) {
            Nivel::Casual(_) => string::append(&mut estado, utf8(b"Casual")),
            Nivel::Fanatico(_) => string::append(&mut estado, utf8(b"Fanatico")),
            Nivel::Leyenda(_) => string::append(&mut estado, utf8(b"Leyenda"))
        };
        estado
    }
}